...
CREATE TABLE `users` (
  ...
  `sex` int(11) NOT NULL COMMENT 'gender 1:male  0:female  2:private',
  ...
  `can_imooc_num_be_updated` int(1) NOT NULL COMMENT 'modify id 1：default,can be modified；0，cannot be modified',
