	...
	<view class="page">
		...
		<view class="qrcode-box" style="width: 550rpx;height: 700rpx;margin-top: 320rpx;align-self: center;">
			...
			<view class="user-box">
				...
				<text style="align-self: center; margin-top: 10rpx;font-size: 14px;font-weight: 400;">Mingkang</text>
				...
				<text style="align-self: center; margin-top: 20rpx;color: #808080;font-size: 11px;font-weight: 300;">Scan the code to see vlogs.</text>
			</view>
